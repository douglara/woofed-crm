...
RSpec.describe Plugins::Adapters::TextLine do
  ...
  describe "error handling" do
    ...
    it "raises PatchError for an unknown operation type" do
      op = Plugins::FilePatch::Operation.new(type: :unknown, options: {}, block: nil)

      expect { described_class.apply("line\n", [op]) }.to raise_error(
        Plugins::FilePatch::PatchError, /Unknown operation/
      )
    end
  end
