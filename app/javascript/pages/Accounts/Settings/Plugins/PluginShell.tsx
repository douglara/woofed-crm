/**
 * PluginShell – wrapper for all Plugin Inertia pages.
 *
...
export default function PluginShell({ settingsUrl, children }: Props) {
  const handleClose = () => {
    // Full page navigation → exits Inertia overlay, returns to Hotwire CRM
    ...
    <div className="flex flex-col h-full overflow-hidden bg-light-palette-p4">
      ...
      <div className="flex items-center justify-between px-5 h-12 border-b-2 border-light-palette-p3 bg-light-palette-p5 flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="typography-text-m-lh150 text-dark-gray-palette-p1">Plugins</span>
