...
Pagy::VARS[:overflow] = :empty_page    # options: [:last_page, :empty_page, :exception]
...
# load the "pt-BR" locale defined in the custom file at :filepath:
# Pagy::I18n.load(locale: 'pt-BR', filepath: Rails.root.join('config', 'locales', 'pagy.pt-BR.yml').to_s)
