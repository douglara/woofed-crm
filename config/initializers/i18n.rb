LANGUAGES_CONFIG = {
  ...
  20 => { name: '中文 (台湾) (zh-TW)', iso_639_3_code: 'zho', iso_639_1_code: 'zh-TW', enabled: false },
  ...
  30 => { name: '中文 (zh-CN)', iso_639_3_code: 'zho', iso_639_1_code: 'zh-CN', enabled: false },
...
# Set available locales from the enabled languages
I18n.available_locales = LANGUAGES_CONFIG.map { |_index, lang| lang[:iso_639_1_code].to_sym }
...
# Ensure all locales are strings and properly formatted
I18n.available_locales = I18n.available_locales.map { |locale| locale.to_s.gsub('_', '-') }
I18n.default_locale = I18n.default_locale.to_s.gsub('_', '-')
