...
module.exports = {
  ...
  plugins: [
    ...
    function ({ addVariant, addUtilities }) {
      // shadcn data-* variants (Tailwind v3 equivalent of @custom-variant)
      addVariant(
        "data-open",
        '&[data-state="open"], &[data-open]:not([data-open="false"])',
      );
      addVariant(
        "data-closed",
        '&[data-state="closed"], &[data-closed]:not([data-closed="false"])',
      );
      addVariant(
        "data-checked",
        '&[data-state="checked"], &[data-checked]:not([data-checked="false"])',
      );
      addVariant(
        "data-unchecked",
        '&[data-state="unchecked"], &[data-unchecked]:not([data-unchecked="false"])',
      );
      addVariant("data-selected", '&[data-selected="true"]');
      addVariant(
        "data-disabled",
        '&[data-disabled="true"], &[data-disabled]:not([data-disabled="false"])',
      );
      addVariant(
        "data-active",
        '&[data-state="active"], &[data-active]:not([data-active="false"])',
      );
      addVariant("data-horizontal", '&[data-orientation="horizontal"]');
      addVariant("data-vertical", '&[data-orientation="vertical"]');

      // shadcn no-scrollbar utility
      addUtilities({
        ".no-scrollbar": {
