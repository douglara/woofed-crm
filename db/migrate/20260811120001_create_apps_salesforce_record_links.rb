class CreateAppsSalesforceRecordLinks < ActiveRecord::Migration[7.1]
  def change
    create_table :apps_salesforce_record_links do |t|
    ...
    add_index :apps_salesforce_record_links, %i[app_id salesforce_object salesforce_id], unique: true,
                                                                                         name: 'index_salesforce_record_links_on_app_object_and_id'
  end
end
