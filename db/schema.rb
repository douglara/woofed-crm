...
ActiveRecord::Schema.define(version: 20_231_206_223_813) do
  ...
  create_table 'contacts', force: :cascade do |t|
    ...
    t.index %w[app_type app_id], name: 'index_contacts_on_app'
  end
  ...
  create_table 'contacts_deals', force: :cascade do |t|
    ...
    t.index %w[contact_id deal_id], name: 'contact_deal_index', unique: true
  ...
  create_table 'custom_attribute_definitions', force: :cascade do |t|
    ...
    t.index %w[attribute_key attribute_model], name: 'attribute_key_model_index', unique: true
  end
  ...
  create_table 'events', force: :cascade do |t|
    ...
    t.index %w[app_type app_id], name: 'index_events_on_app'
